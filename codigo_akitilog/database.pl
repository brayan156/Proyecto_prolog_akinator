...
adjetivos(cientifico,[fisico,físico,física,astronauta,investigador,cientifica,fisica,biologa,cientifico]).
adjetivos(politico,[presidente,política,político,expresidente,ministro,ministra,diputado,diputada,politico]).
...
adjetivos(limon,[limonense,limon,limón]).
...
referencia_verbos(nacio,[nacio,nace,nació]).

afirmaciones([si,sí,efectivo,correcto,efectivamente,claro]).

preguntas_booleanas(fecha,["¿tu personaje nació en  ","la fecha de nacimiento es "]).
preguntas_booleanas(lugar,["tu personaje nació en  ","tu personaje es originario de "]).
...
pregunta(fecha,["en que año nació tu personaje?", "dime en que año nacio tu personaje"]).
pregunta(lugar,["en que provincia nacio?"]).
pregunta(genero,["Cual es el genero","es masculino o femenino?"]).
pregunta(edad, ["cuantos años tiene?", "cuantas vueltas al sol le ha dado?"]).
...
respuesta(bien_after,[", no ha sido ningun problema", ", más dificil la proxima vez",""]).
respuesta(vacio,["responde algo, no seas timido,pero bien escrito","no te enseñaron a escribir?"]).
